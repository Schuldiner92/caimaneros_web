...
import placeholder from '../../img/s2-01.jpg';
...
const Seccion2 = () => {
    return (
        <Box sx={{ position: 'relative', p: 2 }}>
            ...
            <img src={ball} alt="Balón de Volleyball" style={{...Estilos.balon, left: '50px',paddingLeft:'70px'}} />
            <img src={ball} alt="Balón de Volleyball" style={{...Estilos.balon, left: '150px',paddingLeft:'260px'}} />
            <img src={ball} alt="Balón de Volleyball" style={{...Estilos.balon, left: '250px',paddingLeft:'420px'}} />
        </Box> 
    );
  };
